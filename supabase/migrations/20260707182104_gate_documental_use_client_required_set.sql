...
-- (schema_migrations version=20260707182104, name=gate_documental_use_client_required_set).
-- Reescreve gate e auto-liberação para consultar required_document_sets direto
-- pelo conjunto do cliente (client_required_set), sem depender de client_document_checklist.
