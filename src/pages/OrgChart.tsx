...
const INITIAL_AGENTS: Agent[] = [
  { id: 0, name: "CEO Agent Jus IA", Icon: Crown, color: "#c9a84c", role: "ceo", status: "active", department: ["*","diretoria"], currentTasks: 8, maxConcurrentTasks: 20, description: "Supervisiona todos os diretores e operação global" },
